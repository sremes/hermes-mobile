  ...
  return (
    <>
      ...
      >
        ...
        {/* Fork: window-chrome flip is desktop-only — on narrow viewports the
            rails are edge overlays, so swapping sides has no meaning. */}
        {!narrowViewport && <TitlebarToolButton navigate={navigate} tool={flipTool} />}
